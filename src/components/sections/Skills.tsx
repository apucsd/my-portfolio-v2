  ...
  const skillCategories = [
    {
      ...
      skills: ["React.js", "Next.js", "TypeScript", "JavaScript (ES6+)", "Redux", "Context API", "React Query", "Tailwind CSS", "ShadCN/UI", "Responsive Design"]
    },
    {
      title: "Backend",
      icon: <Server className="w-10 h-10 text-zinc-700 dark:text-primary transition-colors duration-300" />,
      skills: ["Node.js", "Express.js", "RESTful APIs", "GraphQL", "Authentication (JWT, OAuth)", "WebSockets", "API Documentation", "Serverless Functions"]
    },
    {
      title: "Database",
      icon: <Database className="w-10 h-10 text-zinc-700 dark:text-primary transition-colors duration-300" />,
      skills: ["MongoDB", "Mongoose ODM", "Database Design", "Indexing", "Aggregation", "Transactions", "Data Modeling", "Redis (Caching)"]
    },
    {
      title: "DevOps & Tools",
      icon: <Command className="w-10 h-10 text-zinc-700 dark:text-primary transition-colors duration-300" />,
      skills: ["Docker", "Git/GitHub", "CI/CD", "AWS (EC2, S3, Lambda)", "Vercel/Netlify", "Postman", "VPS (DigitalOcean)", "ESLint/Prettier"]
    },
    {
      title: "Core Concepts",
      icon: <Code className="w-10 h-10 text-zinc-700 dark:text-primary transition-colors duration-300" />,
      skills: ["RESTful Architecture", "State Management", "Component Architecture", "Performance Optimization", "Security Best Practices", "Clean Code", "Agile/Scrum"]
    },
    {
      title: "Additional Skills",
      icon: <Globe className="w-10 h-10 text-zinc-700 dark:text-primary transition-colors duration-300" />,
      skills: ["TypeScript", "GraphQL", "Webpack/Vite", "PWA", "Jest/Testing", "Microservices", "Problem Solving", "Team Collaboration"]
    }
  ];
