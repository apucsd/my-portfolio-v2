...
export const apiSlice = createApi({
    ...
    tagTypes: ['Education', 'Projects', 'Experience', 'Skills', 'Courses', 'ContactForms', 'ContactLinks', 'User'],
    endpoints: (builder) => ({
        // Auth endpoints
        ...
        updateContactLinks: builder.mutation<ContactLinks, { id: string; data: Partial<ContactLinks> }>({
            query: ({ id, data }) => ({
